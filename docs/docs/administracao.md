---
sidebar_position: 20
title: "Administração de empresas e planos"
description: "Gerencie empresas, limites dos planos, condições especiais e períodos de teste."
---
...
No seletor de empresa do superadmin, todas as contas aparecem por padrão.
Marque **Somente ativas** para filtrar a lista; desmarque para voltar a mostrar
todas. A busca pelo nome funciona junto com o filtro, e cada empresa mostra a
situação da conta. O filtro segue a mesma classificação operacional da lista
de clientes; contas com pagamento pendente ainda podem aparecer enquanto a
conta continuar operacional.
