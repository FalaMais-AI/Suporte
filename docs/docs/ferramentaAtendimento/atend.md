...
| Conversas de Grupos             | ![alt text](assets1/image-17.png)          |
| Filtros Avançados               | ![alt text](assets1/image-16.png)          |
| Pesquisa                        | ![alt text](assets1/image-15.png)          |
| Contatos                        | ![alt text](assets1/image-14.png)          |
| Carregar mais Conversas         | ![alt text](assets1/image-13.png)          |
| Abrir integração com Wavoip     | ![alt text](assets1/image-12.png)          |
| Enviar mensagem avulsa          | ![alt text](assets1/image-11.png)          |
| Inverter a ordem dos tickets    | ![alt text](assets1/image-10.png)           |
| Buscar ticket por mensagem      | ![alt text](assets1/image-9.png)          |
| Atendimentos em andamento     | ![alt text](assets1/image-8.png)           |
| Atendimentos não iniciados     | ![alt text](assets1/image-7.png)          |
| Atendimentos finalizados      | ![alt text](assets1/image-6.png)          |
...
| Descrição                       | Aparência                                          |
|---------------------------------|----------------------------------------------------|
| Reabrir Ticket: Retome um atendimento que já foi finalizado.              | ![alt text](assets1/image-20.png)          |
| Agendamento de Mensagem: Realize o agendamento de uma mensagem individual para esse contato. Essa mensagem pode conter áudio, arquivo, emoji, etc.            | ![alt text](assets1/image-21.png)         |
| Retornar Ticket para a fila: Direcione o contato de volta para o fim da fila de atendimento. Um novo usuário poderá dar continuidade a esse atendimento.              | ![alt text](assets1/image-22.png)          |
| Resolver: Finalize esse atendimento. O contato que estiver na aba Aberto irá automaticamente para aba Fechado.                       | ![alt text](assets1/image-23.png)          |
| Transferir: Transfira o atendimento para o setor e usuário que dará continuidade ao atendimento desse cliente.                        | ![alt text](assets1/image-24.png)         |
| Chatbot: Transfira o atendimento para um fluxo de chatbot interno.         | ![alt text](assets1/image-25.png)          |
| Canal: Transfira o atendimento para outro canal     | ![alt text](assets1/image-26.png)         |
| Reabrir chamada: reabra uma chamada do Wavoip em andamento         | ![alt text](assets1/image-27.png)         |
| Compartilhar o atendimento com outro usuário         | ![alt text](assets1/image-35.png)        |
...
![alt text](assets1/image-33.png)

![alt text](assets1/image-34.png)

### Funil

Gere oportunidades com o funil.

![alt text](assets1/image-56.png)
...
![alt text](assets1/image-52.png)

![alt text](assets1/image-53.png)

![alt text](assets1/image-54.png)

### Sanitinzar contatos

Essa rotina recria o usuário e fecha todos os tickets associados a esse contato.

![alt text](assets1/image-55.png)